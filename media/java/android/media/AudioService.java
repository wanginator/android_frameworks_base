...
public class AudioService extends IAudioService.Stub {
   ...
   /** @hide Maximum volume index values for audio streams */
    ...
    private void readAudioSettings(boolean userSwitch) {
        ...
        synchronized (mSafeMediaVolumeState) {
            if (mSafeVolumeEnabled && mSafeMediaVolumeState == SAFE_MEDIA_VOLUME_ACTIVE) {
    ...
    private void onCheckMusicActive() {
        synchronized (mSafeMediaVolumeState) {
            if (mSafeVolumeEnabled && mSafeMediaVolumeState == SAFE_MEDIA_VOLUME_INACTIVE) {
    ...
    private void setSafeMediaVolumeEnabled(boolean on) {
        synchronized (mSafeMediaVolumeState) {
            if (mSafeVolumeEnabled && (mSafeMediaVolumeState != SAFE_MEDIA_VOLUME_NOT_CONFIGURED) &&
                    (mSafeMediaVolumeState != SAFE_MEDIA_VOLUME_DISABLED)) {
