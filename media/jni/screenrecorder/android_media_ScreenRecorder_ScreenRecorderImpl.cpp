    ...
    while (!gStopRequested) {
        ...
        case NO_ERROR:
            ...
            if (size != 0) {
                ...
                err = muxer->writeSampleData(buffers[bufIndex], trackIdx,ptsUsec, flags);
                if (err != NO_ERROR) {
...
static void
android_media_ScreenRecorder_native_init(JNIEnv *env, jobject thiz, jint orientation, jint videoWidth, jint videoHeight, jint bitRate, jint timeLimitSec) {
